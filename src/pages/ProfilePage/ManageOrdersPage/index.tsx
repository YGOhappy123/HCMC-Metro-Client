...
// import MyBookingCard from '@/pages/ProfilePage/ManageOrdersPage/MyBookingCard'

// const ManageOrdersPage = () => {
//     const [page, setPage] = useState(1)

//     useTitle('HCMC Metro | Đơn Đặt Phòng')
//     useEffect(() => {
...
//             <h3 className="font-oswald text-primary text-4xl leading-[50px] uppercase">Đơn đặt phòng của tôi</h3>
