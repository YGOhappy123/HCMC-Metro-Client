            ...
            <div className="border-primary flex flex-col gap-3 rounded-2xl border-2 bg-white px-11 py-9">
                <div className="flex items-start justify-between">
                    <div className="flex flex-col gap-3">
                        <h2 className="text-accent text-3xl font-semibold">Mã booking {booking.id}</h2>
                        <p className="text-lg">
                ...
                <div className="flex flex-col gap-3">
                    <h3 className="text-primary text-2xl font-semibold">Thời gian thuê phòng</h3>
                ...
                <div className="flex flex-col gap-3">
                    <AccordionItem value="item-1" className="border-none">
                        <AccordionTrigger>
                            <h3 className="text-primary text-2xl font-semibold">Các phòng được chọn</h3>
                        </AccordionTrigger>
                ...
                <div className="flex flex-col gap-3">
                    <AccordionItem value="item-2" className="border-none">
                        <AccordionTrigger>
                            <h3 className="text-primary text-2xl font-semibold">Các dịch vụ được đặt kèm</h3>
                        </AccordionTrigger>
                        <AccordionContent className="p-0">
                            {booking.bookingServices.map((service, index) => (
                                <div key={index} className="mt-3 flex flex-col gap-2">
                                    <h4 className="text-secondary text-xl font-semibold">Mã đơn {service.id!.toString().padStart(2, '0')}:</h4>
                                    <p className="flex items-center justify-between text-lg">
                ...
                <div className="flex flex-col gap-3">
                    <AccordionItem value="item-3" className="border-none">
                        <AccordionTrigger>
                            <h3 className="text-primary text-2xl font-semibold">Lịch sử thanh toán</h3>
                        </AccordionTrigger>
                        <AccordionContent className="p-0">
                            {booking.payments.map((payment, index) => (
                                <div key={index} className="mt-3 flex flex-col gap-2">
                                    <h4 className="text-secondary text-xl font-semibold">Mã giao dịch {payment.id!.toString().padStart(2, '0')}:</h4>
                                    <p className="flex items-center justify-between text-lg">
                ...
                <div className="h-1 bg-black/10"></div>
                <div className="flex flex-col gap-3">
                    <h3 className="text-primary text-2xl font-semibold">Tổng tiền cần thanh toán</h3>
                    <p className="flex items-center justify-between text-lg">
